...
const ALLOWED_ORIGINS = ['https://www.PDFusion.com', 'https://PDFusion.com'];
  ...
  try {
    ...
    if (!response) {
      response = await fetch(targetUrl, {
        headers: {
          'User-Agent': 'PDFusion-WASM-Proxy/1.0',
          Accept: '*/*',
        },
      });
