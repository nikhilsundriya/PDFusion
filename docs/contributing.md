...
Thank you for your interest in contributing to PDFusion! This guide will help you get started.
...
git clone https://github.com/YOUR_USERNAME/PDFusion.git
cd PDFusion
...
See [TRANSLATION.md](https://github.com/nikhilsundriya/blob/main/TRANSLATION.md) for adding new languages.

## Contributor License Agreement

Before your PR can be merged, you'll need to sign our CLA:

- [Individual CLA (ICLA)](https://github.com/nikhilsundriya/blob/main/ICLA.md)
- [Corporate CLA (CCLA)](https://github.com/nikhilsundriya/blob/main/CCLA.md)

## Getting Help

- [GitHub Issues](https://github.com/nikhilsundriya/issues)
- [Discord Community](#)

## License

PDFusion is dual-licensed:
