...
export default defineConfig({
    title: "PDFusion Docs",
    description: "Documentation for PDFusion - The free, open-source, privacy-first PDF toolkit",
    base: '/docs/',
    ...
    themeConfig: {
        ...
        socialLinks: [
            { icon: 'github', link: 'https://github.com/nikhilsundriya/' },
            { icon: 'discord', link: '#' }
        ],

        footer: {
            message: 'Dual-licensed under AGPL-3.0 and Commercial License.',
            copyright: 'Copyright © 2026 PDFusion'
        },
