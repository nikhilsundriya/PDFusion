...
Host PDFusion using Apache HTTP Server.
...
```bash
sudo mkdir -p /var/www/PDFusion
sudo cp -r dist/* /var/www/PDFusion/
sudo chown -R www-data:www-data /var/www/PDFusion
```

## Step 3: Apache Configuration

Create `/etc/apache2/sites-available/PDFusion.conf`:
...
<VirtualHost *:443>
    ServerName your-domain.com
    DocumentRoot /var/www/PDFusion

    SSLEngine on
    SSLCertificateFile /etc/letsencrypt/live/your-domain.com/fullchain.pem
    SSLCertificateKeyFile /etc/letsencrypt/live/your-domain.com/privkey.pem

    <Directory /var/www/PDFusion>
...
Create `/var/www/PDFusion/.htaccess`:
...
```bash
sudo chown -R www-data:www-data /var/www/PDFusion
sudo chmod -R 755 /var/www/PDFusion
```
