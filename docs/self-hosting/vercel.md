...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/nikhilsundriya/)

## Manual Deployment

### Step 1: Fork the Repository

Fork [PDFusion/PDFusion](https://github.com/nikhilsundriya/) to your GitHub account.
...
| `VITE_BRAND_NAME`       | Custom brand name (replaces "PDFusion")                     |
...
::: warning Large Files
Vercel's serverless functions have a 50MB limit. Since PDFusion is a static site, this shouldn't affect you, but WASM modules are large (~100MB total). Ensure they're served from the `/public` folder.
:::
