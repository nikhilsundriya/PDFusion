/*
 * coherentpdf.global.d.ts — TypeScript type definitions for PDFusion / CoherentPDF integration
 *
 * These type definitions were written by Alam for use in the PDFusion project.
